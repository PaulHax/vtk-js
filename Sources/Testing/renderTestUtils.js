...
// Kept separate from testUtils: vtkGenericRenderWindow pulls in the whole
// rendering stack, which tests without a view should not pay for.

// A tracked view that has rendered an empty scene: any count beyond
// emptySceneObjects belongs to the code under test.
function createTrackedRenderView(gc, initialValues = {}) {
...
async function expectSameImageAfterRelease(createActor) {
...
export default { createTrackedRenderView, expectSameImageAfterRelease };
